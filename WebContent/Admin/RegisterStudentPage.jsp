...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	<form id="modal-form-regis-student" accept-charset="UTF-8"  data-remote="true"
		action="RegisterStudentServlet" method="post" name="registerStudentchk"
		class="form-horizontal"	onSubmit="JavaScript:return registerStudent();">
		...
		<div class="form-group">
			...
			<div class="col-lg-8">
				<div class="ui-select">
					<select id="antecedent_stu" class="form-control"
						name="antecedent_stu">
		...
		<div class="form-group">
			...
			<div class="col-lg-8">
				<div class="ui-select">
					<select name="selectMajorName" id="selectMajorName"
						class="form-control" onchange="ListEducation()"></select>
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-lg-8">
				<div class="ui-select">
					<select class="form-control" name="antecedent_par">
						<option value="นาย">นาย</option>
						<option value="นาง">นาง</option>
						<option value="นางสาว">นางสาว</option>
					</select>
