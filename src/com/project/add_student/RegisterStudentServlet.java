	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (majorName == null) {
			...
			if (request.getParameter("studentID_stu") != null) {
				...
				AddressBean address = new AddressBean(addNo_regis, moo_regis, street_regis, subDistrict_regis, district_regis, province_regis,
						zipCode_regis);
				...
				try {
					...
					request.setAttribute("ErrorMassage", "รหัสนักศึกษาซ้ำ");
