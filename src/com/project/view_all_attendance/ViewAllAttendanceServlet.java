	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (majorStudent == null) {
				...
				// DateSchedule
				List<String> listDateSchedule = viewAllAttendanceMng.ListDateSchedule(major.getMajorName(), selectEducation, selectEducation1,
						listTerm.get(listTerm.size() - 1).toString());
				request.getSession().setAttribute("listDateSchedule", listDateSchedule);

				// Present มาเข้าแถว
				List<Integer> listPresent = viewAllAttendanceMng.ListPresent(major.getMajorName(), selectEducation, selectEducation1,
						listDateSchedule);
				...
				// SickLeave ลาป่วย
				List<Integer> listSickLeave = viewAllAttendanceMng.ListSickLeave(major.getMajorName(), selectEducation, selectEducation1,
						listDateSchedule);
				request.getSession().setAttribute("listSickLeave", listSickLeave);

				// PersonalLeave ลากิจ
				List<Integer> listPersonalLeave = viewAllAttendanceMng.ListPersonalLeave(major.getMajorName(), selectEducation, selectEducation1,
						listDateSchedule);
				...
				List<String> listDateSchedule = viewAllAttendanceMng.ListDateSchedule(majorStudent, selectEducation,
						Integer.parseInt(selectEducation1), chkTerm);
				request.getSession().setAttribute("listDateSchedule", listDateSchedule);

				// Present มาเข้าแถว
				List<Integer> listPresent = viewAllAttendanceMng.ListPresent(majorStudent, selectEducation, Integer.parseInt(selectEducation1),
						listDateSchedule);
				request.getSession().setAttribute("listPresent", listPresent);

				// Lack ขาด
				List<Integer> listLack = viewAllAttendanceMng.ListLack(majorStudent, selectEducation, Integer.parseInt(selectEducation1),
						listDateSchedule);
				request.getSession().setAttribute("listLack", listLack);

				// SickLeave ลาป่วย
				List<Integer> listSickLeave = viewAllAttendanceMng.ListSickLeave(majorStudent, selectEducation, Integer.parseInt(selectEducation1),
						listDateSchedule);
				request.getSession().setAttribute("listSickLeave", listSickLeave);

				// PersonalLeave ลากิจ
				List<Integer> listPersonalLeave = viewAllAttendanceMng.ListPersonalLeave(majorStudent, selectEducation,
						Integer.parseInt(selectEducation1), listDateSchedule);
				request.getSession().setAttribute("listPersonalLeave", listPersonalLeave);

				// Late สาย
				List<Integer> listLate = viewAllAttendanceMng.ListLate(majorStudent, selectEducation, Integer.parseInt(selectEducation1),
						listDateSchedule);
				request.getSession().setAttribute("listLate", listLate);
